...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:RadioButton ID="RadioButton1" runat="server" Text="看書" Font-Size="X-Large"   GroupName="rbg_Interest" Checked="True" AutoPostBack="True" />
            <asp:RadioButton ID="RadioButton2" runat="server" Font-Size="X-Large" GroupName="rbg_Interest" Text="打電動" AutoPostBack="True"  />
            <asp:RadioButton ID="RadioButton3" runat="server" Font-Size="X-Large" GroupName="rbg_Interest" Text="其他" AutoPostBack="True"  /><br />
            <asp:Label ID="Label4" runat="server" Text="其他連結" Font-Size="X-Large"></asp:Label>
            <asp:HyperLink ID="HyperLink1" runat="server" Height="30px" ImageUrl="aws-brands.svg" NavigateUrl="https://aws.amazon.com/tw/" Width="30px"></asp:HyperLink><br />
